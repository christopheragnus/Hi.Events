            ...
            <div className={classes.items}>
                ...
                <div className={classes.itemRow}>
                    ...
                    <div className={classes.itemValue}>
                        <Currency
                            currency={event.currency}
                            price={order.total_before_additions_cents}
                    ...
                    <>
                        ...
                        <div className={classes.itemRow}>
                            ...
                            <div className={classes.itemValue}>
                                - <Currency
                                    currency={event.currency}
                                    price={order.total_refunded_cents}
                                />
                            </div>
                        </div>
                    </>
                ...
                <div className={classes.itemRow}>
                    ...
                    <div className={classes.itemValue}>
                        <Currency
                            currency={event.currency}
                            price={
                                order.total_refunded_cents ? order.total_gross_cents - order.total_refunded_cents : order.total_gross_cents
                            }
                            freeLabel={showFreeWhenZeroTotal ? t`Free` : null}
                        />
                    </div>
