        ...
        <>
            <PageBody>
                ...
                {attendeesQuery.isError && (
                    <Alert color="red" title={t`Error Loading Attendees`}>
                        {t`There was a problem fetching the attendee data. Please try again later.`}
                    </Alert>
                )}

                {!attendeesQuery.isError && <TableSkeleton isVisible={!attendees || attendeesQuery.isFetching} />}
